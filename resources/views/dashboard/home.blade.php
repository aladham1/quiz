                ...
                @forelse ($latest_exams as $exam)
                    <li>
                        <div class="nhlBx">
                            ...
                            <div class="nhRw1">
                                <a href="{{ route('groups.show', ['group' => $exam->group_id]) }}" style="color: #000">
                                    <span class="clqBx"></span></a>
                                <div class="nhrImg">
                                    @php
                            ...
                            <div class="qsRow1 q4c">
                                <a href="{{ route('exams.intro', ['exam' => $exam->id]) }}"> <span class="clqBx"></span>
                                </a>
                                <div class="nh1img">
                                    <img
                                        src="{{ isset($exam->icon) ? Storage::url($exam->icon) : 'images/placeholder.jpeg' }}"/>
                                </div>
                                <div class="qs1Rbx">
                                ...
                                <div class="clBtn">
                                    ...
                                    <aside class="setRnew q4d">
                                        <span class="btnIc"
                                              onclick="shareData('{{ $exam->title }}','{{ $exam->title }} - {{ $exam->owner_name }}','{{ route('exams.intro', ['exam' => $exam->id]) }}')"><img
                                                src="images/share_v.svg"></span>
