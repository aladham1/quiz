        ...
        <div class="ptb2">
            <ul>
                ...
                <li> <a href="{{ route('groups.index') }}"
                        style="color:#000">
                        <div class="ptb2Icn" style="font-weight:bold; font-size:25px"> {{ $user->following_count }}</div>
            ...
            @if ($id == Auth::id())
                ...
                <li onclick="tabMove(this,'projects')" class="project_li">
                    <a href="#project" style="color:#511285">
                        <span class="icnp icni"></span><span class="icnTxt">Projects</span><span class="another_cls" class="icnp">P</span>
                    </a>
                </li>
            @endif
        </ul>
                        ...
                        <div class="qsWbx" style="padding: 0 10px 0 0;">
                            ...
                            <div class="qsRow1 q4c">
                                ...
                                <div class="qs1img" style="border-radius: 5px 0 0 5px;">
                                    <img src="@if ($group->image != null || $group->image != '') {{ url(Storage::url($group->image)) }} @else {{ $default_grp_img }} @endif">
                                </div>
                                <div class="qs1Rbx">
...
{{--                                <a href="{{ route('exams.edit', ['exam' => $exam->id]) }}"> <span class="clqBx"></span></a>--}}
                                ...
                                <aside class="setRnew q4d">
                                    <span class="btnIc"
                                        onclick="shareData('{{ $exam->title }}','{{ $exam->title }} - {{ $user->name }}','{{ route('exams.intro', ['exam' => $exam->id]) }}')"><img
                                            src="{{ url('images/share_v.svg') }}"></span>
            ...
            <div class="fIcnBx">
                <aside class="dropSet">
                    ...
                    <div class="fList">
                        <ul class="chkList">
                            <li class="set1">
                                <input type="checkbox" id="set1" name="filter" checked onchange="filterHistory('all')">
                            ...
                            <li class="set5">
                                <input type="checkbox" id="set5" name="filter" checked onchange="filterHistory('fail')">
            ...
            <aside class="qsLst">
                ...
                <ul id="history_list">
                    ...
                    <li status="{{ $sts }}" class="hstBx">
                        <div class="qsWbx">
                            <div class="qsRow1">
                            <span class="clqBx" style="right: 210px" onclick="showHistryReward('{{ route('exams.showReward', ['exam' => $exam->id]) }}')"></span>
                                <div class="qs1img">
                                    <img src="@if ($exam->icon != null || $exam->icon != '') {{ Storage::url($exam->icon, true) }} @else {{ $default_grp_img }} @endif">
                                </div>
                                <div class="qs1Rbx">
                                    ...
                                    <div class="qsTxt4">
                                        <div class="qsTxt5">
                                            @if($percentage>=90 && $percentage<=100)
                                                <img src="{{ url('images/star.svg') }}"/> <img src="{{ url('images/star.svg') }}"/> <img src="{{ url('images/star.svg') }}"/>
                                            ...
                                            @elseif($percentage>=60 && $percentage<=74)
                                                <img src="{{ url('images/star.svg') }}"/> <img src="{{ url('images/star_b.svg') }}"/> <img src="{{ url('images/star_b.svg') }}"/>
                                            @else
                                                <img src="{{ url('images/star_b.svg') }}"/> <img src="{{ url('images/star_b.svg') }}"/> <img src="{{ url('images/star_b.svg') }}"/>
                                            @endif
                                            <!-- <img src="{{ url('images/star.svg') }}"> <img src="{{ url('images/star.svg') }}"> <img src="{{ url('images/star_b.svg') }}"> -->
                                        </div>
                                        <div class="qsTxt6">
                                    ...
                                    @if($percentage>=$exam->pass_percentage /*check for project submit*/ )
                                        @if(count($exam->project_submits) > 0)
                                            @foreach ($exam->project_submits as $ps)
                                                ...
                                                @elseif($ps->remark==1)
                                                    @if($ps->remark_notes!='')
                                                        <span class="cmmnt_i" onclick="openComment('{{ route('exams.project_submits.showComment', ['projectSubmit' => $ps->id ]) }}')">comment</span>
                                                    @endif
                                                    <span class="pass_i" onclick="showHistryReward('{{ route('exams.showReward', ['exam' => $exam->id]) }}')">PASS</span>
                                                @elseif($ps->remark==0)
                                                    @if($ps->remark_notes!='')
                                                        <span class="cmmnt_i" onclick="openComment('{{ route('exams.project_submits.showComment', ['projectSubmit' => $ps->id ]) }}')">comment</span>
                                                    @endif
                                                    <a href="{{ route('exams.project_submits.create', ['exam' => $exam->id]) }}"><span class="pasT" style="background: #F232A4" >Re-Submit</span></a>
                                                @endif
                                                @break
                                            @endforeach
                                        @else
                                            @if($exam->projects_count > 0 /*check if exam has project*/)
                                                <a href="{{ route('exams.project_submits.create', ['exam' => $exam->id]) }}"><span class="pasT" style="background: #F232A4" >Submit project</span></a>
                                            @else
                                                <span class="pass_i" onclick="showHistryReward('{{ route('exams.showReward', ['exam' => $exam->id]) }}')" >PASS</span>
                                            @endif
                                        @endif
                        ...
                        <li status="{{ $project->remark }}">
                            <div class="qsWbx">
                                <div class="prjB1">
                                    <a style="color:#5939C6" href="{{ route('exams.project_submits.show', ['exam' => $exam->id, 'project_submit' => $project->id]) }}">
                                        {{ $exam->title }}
                                    </a>
                                </div>
                                <div class="prjB2">
                                    <a style="color:#000000" href="{{ route('exams.project_submits.show', ['exam' => $exam->id, 'project_submit' => $project->id]) }}" >
                                ...
                                <div class="prjB3">
                                    ...
                                    @if($project->remark_notes!='')
                                        <span class="cmmnt_i" onclick="openComment('{{ route('exams.project_submits.showComment', ['projectSubmit' => $project->id ]) }}')">comment</span>
                                    @endif
                                </div>
                            </div>
                        </li>
                    ...
                    <li status="{{ $project->remark }}" class="hstBx">
                        <div class="qsWbx">
                            <div class="qsRow1">
                                ...
                                <div class="qs1img">
                                    <img src="@if ($parent_exam->icon != null || $parent_exam->icon != ''){{ Storage::url($parent_exam->icon, true) }}@else{{ $default_grp_img }}@endif">
                                </div>
                                <div class="qs1Rbx">
                                    <div class="qsTxt2">
                            ...
                            <div class="qsRow2">
                                ...
                                @elseif($project->remark==1)
                                    @if($project->remark_notes != '' || $project->remark_notes != null )
                                        <span class="cmmnt_i" onclick="openComment('{{ route('exams.project_submits.showComment', ['projectSubmit' => $project->id ]) }}')">comment</span>
                                    @endif
                                    <span class="pass_i" onclick="showHistryReward('{{ route('exams.showReward', ['exam' => $parent_exam->id]) }}')">PASS</span>
                                @elseif($project->remark==0)
                                    @if($project->remark_notes != '' || $project->remark_notes != null )
                                        <span class="cmmnt_i" onclick="openComment('{{ route('exams.project_submits.showComment', ['projectSubmit' => $project->id ]) }}')">comment</span>
                                    @endif
                                    <a href="{{ route('exams.project_submits.create', ['exam' => $parent_exam->id]) }}"><span class="pasT" style="background: #F232A4" >Re-Submit</span></a>
                                @endif
                    ...
                    @foreach ($exam->project_submits as $project)
                        ...
                        <li>
                            <div class="qsWbx">
                                ...
                                <div class="prjB3">
                                        <div class="prjFl"><a href="#" onclick="markSubmission(0, '{{ route('exams.project_submits.update', ['exam' => $exam->id, 'project_submit' => $project->id]) }}')" style="color:#ffff">FAIL</a></div>
...
<footer class="ftrmnu">
    ...
    <div class="fmnuclm">
        <a href="{{ route('profile') }}">
            <div class="icnUsr"
                style="background: url(<?=$base_url?>/images/user_icon.svg) no-repeat center center #F232A4">PROFILE
...
<div class="popBttom" id="togdtl" style="">
    ...
    <div class="popSet1">
        <div class="gDtlBx">
            ...
            <aside class="lin1">
                <div class="l1Bx1"><img class="owner_img" height="35px" width="35px" src="{{ url('images/prf.png') }}" /></div>
                <div class="l1Bx2 owner_name">Fahad alawam</div>
                <div class="l1Bx3 create_date">25 Apr, 2020</div>
            </aside>

            <aside class="lin2">
                <div class="l2Bx1"><img class="grp_img" height="70px" width="70px" src="{{ url('images/math.jpg') }}" /></div>
                        ...
                        <div class="crt1" style="border: 1px solid #511285; padding: 15px;">
                            <div class="crt2" style="text-align: center; position: relative;">
                                ...
                                <div class="crLne4" style="color: #707070; font-size: 16px;">
                                    ...
                                    <div class="crLne41" style="padding: 0 0 12px 0;">
                                        <div class="crLne42" style="display: inline-block; font-style: italic;"><span
                                    ...
                                    <div class="crLne41" style="padding: 0 0 12px 0;">
                                        on<div class="crLne42" style="display: inline-block; font-style: italic;"><span
                                                class="cert_xm_date"
                                                style="font-weight: bold; padding: 0 2px; border-bottom: 1px solid rgba(112, 112, 112, 0.6);"><?=date('d-m-Y')?></span>
                                        </div>@ <div class="crLne42" style="display: inline-block; font-style: italic;">
                                ...
                                <div class="crLne60" style="text-align: left;">
                                    <div class="crLne6"
                                        ...
                                        <div class="crLne7" style="border-bottom: 1px solid rgba(112, 112, 112, 0.6);">
                                ...
                                <div class="crLne4">
                                    ...
                                    <div class="crLne41">
                                        <div class="crLne42"><span class="cert_student_name"
                                                style="font-weight: bold;"><?=$result_my['name']?></span></div>
                                    </div>
                                    <div class="crLne41">
                                    ...
                                    <div class="crLne41">
                                        <div class="crLne42"><span class="cert_xm_date"
                                                style="font-weight: bold;"><?=date('d-m-Y')?></span></div>@ <div
                                            class="crLne42"><span class="cert_xm_time"
                                                style="font-weight: bold;"><?=date('h:i:s A')?></span></div> في يوم
                                    </div>
                                    <div class="crLne41">
