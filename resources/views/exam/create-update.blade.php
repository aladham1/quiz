            ...
            <div class="swiper-slide">
                <div class="ssinBx">
                    <aside class="whtBx1">
                        ...
                        <div class="q1t2"><img id="blah" height="114px" width="114px" src=" {{ asset("images/image.svg")  }} " onclick="chooseImage()" /></div>
                        ...
                        <div class="inSet preqVal" style="display: none">
                            ...
                            <div class="forHint">
                                <input type="text" class="infld preq_value" placeholder="" />
                    ...
                    <aside class="chkSet">
                        ...
                        <ul class="chkList">
                            <li>
                                ...
                                <label for="set1"><span>Randomize questions order</span> <span class="qinfo">?</span></label>
                            </li>
                            <li>
                            ...
                            <li style="">
                                ...
                                <br />
                                <div class="fieldsBox">
                                    <p style="margin-left: 31px" class="fieldsp"><span>Required Fields</span> <span class="qinfo tooltip">?</span></p>
                                    <input type="text" class="infld2 login_fields" style="min-width: 150px" placeholder="" />
                                </div>
                            </li>
                            <li>
                                <input type="checkbox" id="set4" class="timeLimit" onclick="showtmBx()" name="settings">
                                <label for="set4"><span>Time limit (minutes) <span class="qinfo">?</span></span></label>
                                <br />
                                <input type="tel" style='display: none' class="infld2 nmbrOnly tmBx" placeholder="" />
                            </li>
                        </ul>
                ...
                <div class="ssinBx">
                    <section class="">
                        ...
                        <div class="rsltFrm">
                            ...
                            <div class="inSet">
                                <h6><span>Number Of Questions To Show Students </span> <span class="qinfo">?</span></h6>
                            ...
                            <div class="inSet">
                                ...
                                <select class="infld rew_mod swiper-no-swiping" onchange="showRewardMode(this.value)">
                            ...
                            <div class="singleModeRew" style="">
                                <div class="inSet">
                                    ...
                                    <select class="infld rew_type swiper-no-swiping" onchange="showRewardMsg(this.value)">
                        ...
                        <div class="rvwBox">
                            <div class="rvwBox2">
                                ...
                                <ul class="subjLst xm_subjects">
                                    <li>
                                        <aside class="subTxt">
                                            <div class="subIcn"><img src=" {{ asset("images/p_text.svg")  }} "></div>
                                            <div class="subTxt2">
                                    ...
                                    <li>
                                        <aside class="subTxt">
                                            <div class="subIcn"><img src=" {{ asset("images/p_note.svg")  }} "></div>
                                            <div class="subTxt2">
                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Auctor diam pharetra a, mauris cras. Volutpat nunc blandit vitae est vitae non mauris mssmassa a nunc ....
                                            </div>
                                        </aside>
                                    </li>
                                    <li>
                                        <aside class="subTxt">
                                            <div class="subIcn"><img src=" {{ asset("images/p_table.svg")  }} "></div>
                                            <div class="subTxt2">
                                                Table
                                            </div>
                                        </aside>
                                    ...
                                    <li>
                                        <aside class="subTxt">
                                            <div class="subIcn"><img src=" {{ asset("images/p_video.svg")  }} "></div>
                                            <div class="subTxt2">
                                                Youtube video
                                            </div>
                                        </aside>
                                    ...
                                    <li>
                                        <aside class="subTxt">
                                            <div class="subIcn"><img src=" {{ asset("images/p_audio.svg")  }} "></div>
                                            <div class="subTxt2">
                                                1:16
                                            </div>
                                        </aside>
                                    ...
                                    <ul class="revQlist">
                                        ...
                                        <li>
                                            <aside class="rqGap">
                                                ...
                                                <span><img src=" {{ asset("images/multiple_choice.svg")  }} " /></span>
                                            </aside>
                                        </li>
                                        <li>
                                            <aside class="rqGap ">
                            ...
                            <div class="rvwBox2">
                                ...
                                <div class="rrTxt1">
                                    <ul class="rrTxt2">
                                        ...
                                        <li>
                                            <span class="rrTc1"> Passing percentage:</span> <span class="rrTc2 xm_percentage">60%</span>
                                        </li>
                                        <li>
                                            <span class="rrTc1">Reward mode:</span> <span class="rrTc2 xm_reward_mode">Single</span>
                                        </li>
                                        <li>
                                            <span class="rrTc1">Reward type:</span> <span class="rrTc2 xm_reward_type">Text</span>
                                        </li>
                                    </ul>
                                </div>
...
<div class="popBttom" id="popP1">
    <div class="popSet1">
        <ul class="pIcnLst" style="height: 230px; overflow-x: hidden !important;">
            ...
            <input type="file" class="introFile" onchange="saveDataPopIntro('file')" style="height:0; width:0; opacity:0">
            <li>
    ...
    <div class="wgmPBx">
        <div class="prjPset">
            ...
            <ul class="pIcnLst wgmIcns">
                <input type="file" accept="image/*" class="prImg" style="height:0; width:0; opacity:0" id="showPrImg">
                ...
                <input type="file" class="projectFile" onchange="saveDataPopIntro('project_file')" style="height:0; width:0; opacity:0">
            </ul>
    ...
    <div class="mchPopx2 mchPopx22">
        ...
        <div class="wgmPBx">
            <div class="wgmWht">
                ...
                <ul class="pIcnLst wgmIcns">
                    <input type="file" accept="image/*" class="mcImg" style="height:0; width:0; opacity:0" id="showMcImg">
                    ...
                    <aside class="chkLne">
                        ...
                        <div class="chkLneR">
                            <ul class="smlRdioIcn">
                                ...
                                <li>
                                    <input type="radio" value="text" id="txtrdio" name="sml_rdio" checked onchange="showAnsArea(1,'text')">
                                    <label for="txtrdio" class="txtrdio"><span>Text</span></label>
                                </li>
                                <li>
                                    <input type="radio" value="image" id="imgrdio" name="sml_rdio" onchange="showAnsArea(1,'image')">
                                    <label for="imgrdio" class="imgrdio"><span>Image</span></label>
                                </li>
                                <input type="file" accept="image/*" class="ansImg_1" style="height:0; width:0; opacity:0" onchange="readAnsImg(this,1)" />
                                <li>
                                    <input type="radio" value="audio" id="vocrdio" name="sml_rdio" onchange="showAnsArea(1,'audio')">
                    ...
                    <aside class="chkLne">
                        ...
                        <div class="chkLneR">
                            <ul class="smlRdioIcn">
                                ...
                                <li>
                                    <input type="radio" value="text" id="txtrdio2" name="sml_rdio2" checked onchange="showAnsArea(2,'text')">
                                    <label for="txtrdio2" class="txtrdio"><span>Text</span></label>
                                </li>
                                <li>
                                    <input type="radio" value="image" id="imgrdio2" name="sml_rdio2" onchange="showAnsArea(2,'image')">
                                    <label for="imgrdio2" class="imgrdio"><span>Image</span></label>
                                </li>
                                <input type="file" accept="image/*" class="ansImg_2" style="height:0; width:0; opacity:0" onchange="readAnsImg(this,2)" />
                                <li>
                                    <input type="radio" value="audio" id="vocrdio2" name="sml_rdio2" onchange="showAnsArea(2,'audio')">
                    ...
                    <aside class="chkLne">
                        ...
                        <div class="chkLneR">
                            <ul class="smlRdioIcn">
                                ...
                                <li>
                                    <input type="radio" value="text" id="txtrdio3" name="sml_rdio3" checked onchange="showAnsArea(3,'text')">
                                    <label for="txtrdio3" class="txtrdio"><span>Text</span></label>
                                </li>
                                <li>
                                    <input type="radio" value="image" id="imgrdio3" name="sml_rdio3" onchange="showAnsArea(3,'image')">
                                    <label for="imgrdio3" class="imgrdio"><span>Image</span></label>
                                </li>
                                <input type="file" accept="image/*" class="ansImg_3" style="height:0; width:0; opacity:0" onchange="readAnsImg(this,3)" />
                                <li>
                                    <input type="radio" value="audio" id="vocrdio3" name="sml_rdio3" onchange="showAnsArea(3,'audio')">
                    ...
                    <aside class="chkLne">
                        ...
                        <div class="chkLneR">
                            <ul class="smlRdioIcn">
                                ...
                                <li>
                                    <input type="radio" value="text" checked id="txtrdio4" name="sml_rdio4" checked onchange="showAnsArea(4,'text')">
                                    <label for="txtrdio4" class="txtrdio"><span>Text</span></label>
                                </li>
                                <li>
                                    <input type="radio" value="image" id="imgrdio4" name="sml_rdio4" onchange="showAnsArea(4,'image')">
                                    <label for="imgrdio4" class="imgrdio"><span>Image</span></label>
                                </li>
                                <input type="file" accept="image/*" class="ansImg_4" style="height:0; width:0; opacity:0" onchange="readAnsImg(this,4)" />
                                <li>
                                    <input type="radio" value="audio" id="vocrdio4" name="sml_rdio4" onchange="showAnsArea(4,'audio')">
...
<div class="prgPopBx" id="wgmPop" style="display: none;">
    ...
    <div class="wgmPBx">
        <div class="wgmWht">
            ...
            <ul class="pIcnLst wgmIcns">
                <input type="file" accept="image/*" class="wgImg" style="height:0; width:0; opacity:0" id="showWgImg">
...
<div class="tblPopBx" id="tablePop" style="display: none;">
    <div class="tablAction">
        <div class="taRow">
            ...
            <div class="acXb"><input type="range" min="1" max="10" onchange="renderRows()" value="2" class="slider IntrPopRow" id="rows"></div>
            <div class="acXc"><span id="rowsv"></span></div>
        </div>
        <div class="taClmn">
            <div class="acXa">Columns</div>
            <div class="acXb"><input type="range" min="1" max="10" onchange="renderColumns()" value="2" class="slider IntrPopClm" id="columns"></div>
